...
class AuthCubit extends Cubit<AuthState> {
  ...
  /// Atualiza o grupo ativo do usuário atual
  Future<void> updateActiveGroup(String groupId) async {
    if (state is AuthAuthenticated) {
      try {
        final updatedUser = await _authRepository.updateActiveGroup(groupId);
        emit(
          AuthAuthenticated(updatedUser),
        ); // Emite novo estado autenticado com o usuário atualizado
      } catch (e) {
