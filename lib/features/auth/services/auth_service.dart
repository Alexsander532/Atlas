...
class AuthService {
  ...
  /// Define o grupo ativo do usuário no Firestore.
  Future<UserModel> updateActiveGroup(String groupId) async {
    final user = _firebaseAuth.currentUser;
    if (user == null) throw const AuthException('Usuário não autenticado');
    ...
    try {
      ...
      throw AuthException('Erro ao atualizar grupo ativo: $e');
    }
  }
